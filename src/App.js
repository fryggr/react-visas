    ...
    getRestrictForDate(datePickerName) {
        ...
        if (datePickerName === "birthDate" || datePickerName === "passportIssued") {
            ...
            return function(current) {
                ...
                return (
                    current.isAfter(sixMonthAfterToday) &&
            ...
            <div className="App text-center text-md-left">
                ...
                <div className="container mt-4">
                    <div className="row" style={{ maxWidth: "710px" }}>
                        ...
                        <div className={"col-sm-3 " + (this.state.currentStep === 0 ? "d-none" : "d-block")}>
                            <Button
                        ...
                        <div className={"col-sm-3 " + (this.state.currentStep === 3 ? "d-none" : "d-block")}>
                            <Button
                                handleClick={() => this.updateField("currentStep", this.state.currentStep + 1)}
