...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      OptionsRegistration: [
        { value: "1", label: "No registration services needed" },
        { value: "2", label: "Registration in Moscow" }
      ],
      OptionsDelivery: [
        { value: "1", label: "Email" },
      ...
      OptionsCities: [
        ...
        { value: "2", label: "Magadan" }
      ],
      OptionsHotels: [
        { value: "1", label: "Vzlyot" },
        { value: "2", label: "Park inn" }
      ]
    };
  ...
  validate() {
    ...
    for (let i = 0; i < state.visitors.length; i++) {
      inputFields["visitors." + i + ".firstName"] =
        state.visitors[i].firstName.value;
      inputFields["visitors." + i + ".middleName"] =
        state.visitors[i].middleName.value;
      inputFields["visitors." + i + ".surName"] =
        state.visitors[i].surName.value;
      inputFields["visitors." + i + ".sex"] = state.visitors[i].sex.value;
      inputFields["visitors." + i + ".birthDate"] =
        state.visitors[i].birthDate.value;
      inputFields["visitors." + i + ".citizenship"] =
        state.visitors[i].citizenship.value;
      inputFields["visitors." + i + ".passportNumber"] =
        state.visitors[i].passportNumber.value;
      inputFields["visitors." + i + ".passportIssued"] =
        state.visitors[i].passportIssued.value;
      inputFields["visitors." + i + ".passportExpired"] =
        state.visitors[i].passportExpired.value;
    }

    //add inputFields for location
    for (let i = 0; i < state.locations.length; i++) {
      inputFields["locations." + i + ".city"] =
        state.locations[i].city.value.value;
      inputFields["locations." + i + ".hotel"] =
        state.locations[i].hotel.value.value;
    }
  ...
  renderVisitors() {
    let arr = [];
    for (let i = 0; i < this.state.groupSize.value.value; i++) arr[i] = i;
          ...
          <div className="row" style={{ maxWidth: "655px" }}>
            ...
            <div className="col-md-6">
              <Input
                ...
                visited={
                  this.state.visitors[visitorIndex].passportNumber.visited
                }
          ...
          <div className="row" style={{ maxWidth: "655px" }}>
            <div className="col-md-6">
              <Input
                ...
                visited={
                  this.state.visitors[visitorIndex].passportIssued.visited
                }
            ...
            <div className="col-md-6">
              <Input
                ...
                visited={
                  this.state.visitors[visitorIndex].passportExpired.visited
                }
  ...
  renderArrivalAndDeparture() {
    let arr = [0];
    if (this.state.numberOfEntries.value.value === "Double") arr[1] = 1;
        ...
        <div className="row" style={{ maxWidth: "655px" }}>
          <div className="col-md-6">
            <Input
              ...
              visited={this.state["arrivalDate" + (inputIndex + 1)].visited}
              label={"Entry " + (inputIndex + 1) + " - Arrival date"}
              placeholder=""
              error={this.state["arrivalDate" + (inputIndex + 1)].error}
            />
          </div>
          <div className="col-md-6">
            <Input
              ...
              value={this.state["departureDate" + (inputIndex + 1)].value}
              visited={this.state["departureDate" + (inputIndex + 1)].visited}
              label={"Entry " + (inputIndex + 1) + " - Departure date"}
              placeholder=""
              error={this.state["departureDate" + (inputIndex + 1)].error}
            />
          </div>
        </div>
      );
  ...
  renderLocations() {
    ...
    return [
      ...
      <Button
        className="Button_red-border mr-auto"
        handleClick={() => this.addLocation()}
  ...
  showCurrentStep() {
    if (this.state.currentStep === 0)
      ...
      return (
        <Step number={2} hidden={this.state.currentStep !== 2}>
        ...
        <div className="container mt-4">
          <div className="row" style={{ maxWidth: "710px" }}>
            <div className="col-sm-6">
              <Button
                className="align-self-md-start align-self-center"
                label="Save progress"
              />
            </div>
            ...
            <div
              className={
                "col-sm-3 " +
                (this.state.currentStep === 0 ? "d-none" : "d-block")
              }
            >
              <Button
                handleClick={() =>
                  this.updateField("currentStep", this.state.currentStep - 1)
                }
                className={
                  "Button_red-border align-self-md-end align-self-center"
                }
                label="Previous step"
              />
            </div>
            <div
              className={
                "col-sm-3 " +
                (this.state.currentStep === 3 ? "d-none" : "d-block")
              }
            >
              <Button
                handleClick={() =>
