        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-7">
                    <h2 className="Header__title">Russian Tourist Visa Support Application</h2>
                    {props.userCompleteForm === '1' ? (
                        ''
                    ) : (
                        <StepsNavigation
                        ...
                        <div className="row align-items-center flex-column align-items-md-end flex-md-row">
                            <div className="mr-1 mr-sm-4 mt-3">
                                ...
                                <Select
                                    ...
                                    onChange={selectedCurrency =>
                                        props.updateField('currency', selectedCurrency)
                                    }
                            ...
                            <div className="mt-3">
                                ...
                                <ReactFlagsSelect
                                    ...
                                    countries={['GB', 'RU']}
                                    customLabels={{ RU: 'Русский', GB: 'English' }}
                                    defaultCountry="GB"
